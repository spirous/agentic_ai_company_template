...
Optional flags:
- `--last-brief work/company-presentation/brief_[PRIOR_PERIOD].md` — provide prior brief for continuity
...
|:---|:---|:---:|
| IRL initiative profile | `knowledge/initiatives/[name].md` | Yes |
...
6. Save brief as `work/company-presentation/brief_[PERIOD].md`
...
| Output | Path |
|:---|:---|
| Presenter script | `work/company-presentation/brief_[PERIOD].md` |
