...
1. Read `./engine/sense/agents/discovery_agent.txt`
2. Read `./engine/sense/methodologies/mom-test/principles.md` (the distilled methodology — never read the full book PDF)
3. Route by invocation:
   ...
   - `discovery-verdict "Initiative"` → read all debriefs in `./engine/sense/workflows/customer-discovery/debriefs/` plus the initiative's end-user Demand Signal blocks, run VERDICT mode
