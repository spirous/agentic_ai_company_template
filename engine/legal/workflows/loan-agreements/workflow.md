...
```
engine/legal/workflows/loan-agreements/templates/
...
cp engine/legal/workflows/loan-agreements/active/fields_example.json \
   engine/legal/workflows/loan-agreements/active/fields_COMPANY.json
```
...
fill-loan \
  ...
  --type standard \
  --fields engine/legal/workflows/loan-agreements/active/fields_COMPANY.json \
